...
const Home: NextPage = () => {
  ...
  const editionDrop = useContract("0x58fC95eE72C3D25fA66fdDFC5997D025B34FaD09", "edition-drop").contract;

  // トークンコントラクトの初期化
  const token = useContract("0x1bB0e8341EB5152C8CeFFa2e8ae19097153e5FF8", "token").contract;
  // 投票コントラクトの初期化
  const vote = useContract("0xf9d7416d32B3D63Fe4Bf90c66c983248Dc26c624", "vote").contract;
